...
/// Rust doesn't allow accessing `f64`s that falls out of 8 bytes alignment, therefore this type must be used for such fields when mapping native MQ5 structs.
/// The value may be obtained back by `f64::from_bytes(field)`
